exports.up = pgm => {
  ...
  pgm.addConstraint('playlists', 'fk_playlist.owner_playlist.id', 'FOREIGN KEY(owner) REFERENCES users(id) ON DELETE CASCADE')
...
exports.down = pgm => {
  ...
  pgm.dropConstraint('playlists', 'fk_playlist.owner_playlist.id')
